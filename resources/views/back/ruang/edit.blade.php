                    ...
                    <form method="POST" action="{{ route('ruangs.update', $ruang->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $ruang->nama) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="lantai" id="lantai"
                                    value="{{ old('lantai', $ruang->lantai) }}" required class="input-field" />
                                @error('lantai')
                                <p class="error-text">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="file" name="img" id="img" accept=".jpg,.jpeg,.png" class="input-field"

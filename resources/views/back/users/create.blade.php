...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('anima/createuser.css') }}">
        ...
        <div class="main-content">
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p>Buat akun baru untuk user atau admin</p>
                </div>
                ...
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="name" id="name" required class="input-field" placeholder="Masukkan nama lengkap...">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="email" name="email" id="email" required class="input-field" placeholder="contoh@phr.pertamina.com">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" name="password" id="password" required class="input-field" placeholder="Masukkan password...">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="password" name="password_confirmation" id="password_confirmation" required class="input-field" placeholder="Konfirmasi password...">
                                <span class="input-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg></span>
                            </div>
                        </div>
                    </div>

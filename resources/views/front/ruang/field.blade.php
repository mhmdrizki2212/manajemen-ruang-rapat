...
<body>
    ...
    <div class="main-container">
        ...
        <header>
            <div class="container header-inner">
                ...
                <nav class="main-nav flex justify-center space-x-6">
                    <a href="/" class="text-gray-700 hover:text-red-500">Beranda</a>
                    <a href="/#zona1" class="active text-red-600 font-semibold">Lihat Jadwal</a>
                </nav>
                    ...
                    @foreach($ruangs->where('lantai', $lantai) as $ruang)
                        <div class="ruangan-item"
                            ...
                            <div class="ruangan-info">
                                ...
                                {{-- PERUBAHAN: Menambahkan div dan tombol Pinjam --}}
    ...
    {{-- Modal Detail Riwayat (Tetap Sama) --}}
    ...
    {{-- TAMBAHAN: Modal Form Peminjaman --}}
    <div id="bookingModal" class="modal">
        <div class="modal-content" style="max-width: 850px; padding: 0; background: transparent; box-shadow: none;">
            <div class="form-container">
                ...
                <form id="jadwalForm" action="{{ route('jadwals.store') }}" method="POST">
                    @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // === TAMBAHAN: JAVASCRIPT UNTUK MODAL BOOKING ===
